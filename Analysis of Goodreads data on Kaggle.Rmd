...
```{r}
goodreads <- read.csv('/Users/ngohoanganh/Desktop/Goodreads Kaggle project/booksFIXED.csv', stringsAsFactors = FALSE)
str(goodreads)
head(goodreads)
```
...
ggplot(data = goodreads, aes(x = goodreads$average_rating)) + 
    geom_histogram(aes(y = ..density..),binwidth = 0.01, color='lightgreen', fill='lightgreen') +
