...
First, we will see the correlation between numerical columns of this dataset by using Pearson's R, Kendall rank and Spearman correlation coefficient.
  ...
  - Spearman correlation coefficient is used to examine the strength and direction of the monotonic relationship between two continuous or ordinal variables
