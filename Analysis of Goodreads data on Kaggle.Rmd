...
There is a problem emerging from the model above. As the ratings count is significantly larger than the average rating, this model seems to be in favor of ratings count, which may lead to bias. As a result, we will normalize the two variables and re-build this algorithm. 